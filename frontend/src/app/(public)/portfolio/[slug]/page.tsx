        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
          <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6">
            <div className="relative shrink-0">
              ...
              />
              {profile.role === "membre" || profile.role === "mentor" || profile.role === "formateur" ? (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        {profile.bio && (
          <section className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-widest mb-3">À propos</h2>
        ...
        {profile.skills && profile.skills.length > 0 && (
          <section className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-widest mb-4">Compétences</h2>
        ...
        {profile.experiences && profile.experiences.length > 0 && (
          <section className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-widest mb-6">
              <Briefcase size={14} className="inline mr-2 mb-0.5" />Expériences
            </h2>
        ...
        {profile.certifications && profile.certifications.length > 0 && (
          <section className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-widest mb-4">
              <Award size={14} className="inline mr-2 mb-0.5" />Certifications
            </h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-500 mb-6">Profil introuvable ou non public.</p>
